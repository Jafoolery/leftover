...
#include "server_utils/rapidjson/rapidjson.h"  // version 4af11766-5b9e-4369-baea-4dfafe18d926
...
LeftoverRecord DeserializeLeftoverRecordFromJSON(
   ...
   * `json_obj[kFileDataFoodName].GetString()`. Use that as a function
...
LeftoverRecord QueryStringToLeftoverRecord(
  ...
  // object using the setter in LeftoverRecord class.
  if (query_string.get(kWebDataDate))
    record.SetDate(query_string.get(kWebDataDate));
  if (query_string.get(kWebDataMeal))
    record.SetMeal(query_string.get(kWebDataMeal));
  if (query_string.get(kWebDataFoodName))
    record.SetFoodName(query_string.get(kWebDataFoodName));
  if (query_string.get(kWebDataQtyInOz))
    record.SetQtyInOz(std::stod(query_string.get(kWebDataQtyInOz)));
  if (query_string.get(kWebDataLeftoverReason))
    record.SetLeftoverReason(query_string.get(kWebDataLeftoverReason));
  if (query_string.get(kWebDataDisposalMechanism))
    record.SetDisposalMechanism(query_string.get(kWebDataDisposalMechanism));
  if (query_string.get(kWebDataCost))
